...
import { ServiceSelectScreen } from '@/screens/main/ServiceSelectScreen';
import { SubcategorySelectScreen } from '@/screens/main/SubcategorySelectScreen';
...
export function BookingFlowNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name={HOME_SCREEN.CATEGORY_SUBCATEGORIES} component={SubcategorySelectScreen} />
      <Stack.Screen name={HOME_SCREEN.SUBCATEGORY_SERVICES} component={ServiceSelectScreen} />
