  ...
  return (
    ...
    >
      ...
      >
        ...
        <View className="flex-row items-center justify-between border-t px-3 py-2.5" style={{ borderTopColor: isDark ? uiColors.surface.overlayDark14 : uiColors.surface.overlayStrokeLight }}>
          <View className="mr-3 flex-row items-center">
            <View className="h-7 w-7 items-center justify-center rounded-full" style={{ backgroundColor: isDark ? uiColors.surface.overlayDark10 : palette.light.card }}>
      ...
      <View className="mt-3 flex-row items-center justify-between rounded-xl px-3 py-3" style={{ backgroundColor: isDark ? uiColors.surface.overlayDark10 : uiColors.surface.overlayLight95 }}>
        <Text className="text-xs font-extrabold uppercase text-baseDark dark:text-white">Subtotal</Text>
